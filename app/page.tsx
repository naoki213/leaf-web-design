...
export default function Home(){
 ...
 return <main className="new-site">
  ...
  <section className="image-hero" id="top"><img src="./leaf-hero-v2.png" alt="白い壁の前に置かれた枝ものと花器"/><div className="image-hero-copy"><p>個人のお店・小さな会社のための<br/>ホームページ制作。</p><h1>想いが伝わる、<br/>やさしいホームページを。</h1><div className="hero-rates"><p><small>制作料</small><b>0</b><span>円</span></p><i></i><p><small>公開後</small><em>月額</em><b>2,000</b><span>円</span></p></div><a href="./contact/">無料で相談する <span>→</span></a><small>相談だけでも大丈夫です。</small></div><span className="image-hero-scroll">SCROLL</span></section>
  <section className="phone-hero" id="works">
   <div className="works-heading"><p className="sec-no">制作実績　01—06</p><h2>こんなホームページを、<br/>制作料0円でつくります。</h2><div><p>公開中の6サイトを、そのままスマートフォンで体験できます。</p><span>横にスワイプして見る　→</span></div></div>
  ...
  <section className="vision-banner reveal"><img src="./leaf-sky.png" alt="淡い青空と新緑の枝"/><div><p>ホームページで、</p><h2>お店やサービスの未来を<br/>いっしょに育てていく。</h2><a href="./contact/">無料で相談する <span>→</span></a></div></section>
