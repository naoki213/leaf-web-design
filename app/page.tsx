...
export default function Home(){
 ...
 return <main className="new-site">
  ...
  <section className="new-cta" id="contact"><p>先着3名限定・制作料0円（税込）</p><h2>ホームページ、<br/>そろそろ作りませんか。</h2><a href="#contact-note">無料で制作を相談する <span>→</span></a><small id="contact-note">相談したからといって、契約する必要はありません。サーバー代・ドメイン代は別途必要です。</small></section>
