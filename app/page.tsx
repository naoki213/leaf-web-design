...
export default function Home(){
 ...
 return <main className="new-site">
  ...
  <section className="phone-hero" id="top">
   <div className="phone-hero-copy"><p className="kicker">LEAF WEB DESIGN / TOKYO</p><div className="hero-message"><p className="hero-offer">無料でWebサイトを制作します。</p><h1><span>あなたの仕事が伝わる、</span><i>ホームページを。</i></h1><ul className="hero-points"><li>制作料 0円</li><li>10〜20ページ対応</li><li>公開後 月額2,000円</li></ul></div><div className="hero-guide"><p>まずは、LEAFがつくれるものをご覧ください。6つの公開サイトをスマートフォンで体験できます。</p><span>横にスワイプして見る　→</span></div></div>
