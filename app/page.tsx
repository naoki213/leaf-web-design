...
export default function Home(){
 ...
 return <main className="new-site">
  ...
  <section className="phone-hero" id="top">
   <div className="phone-hero-copy"><p className="kicker">LEAF WEB DESIGN / TOKYO</p><div className="hero-message"><p className="hero-offer">無料でWebサイトを制作します。</p><h1><span>あなたの仕事が伝わる、</span><i>ホームページを。</i></h1><ul className="hero-points"><li>制作料 0円（税込）</li><li>10〜20ページ対応</li><li>公開後 月額2,000円（税込）</li></ul></div><div className="hero-guide"><p>まずは、LEAFがつくれるものをご覧ください。6つの公開サイトをスマートフォンで体験できます。</p><span>横にスワイプして見る　→</span></div></div>
  ...
  <section className="new-price" id="price"><div className="price-title reveal"><span className="sec-no">03 / PRICE</span><p>10〜20ページ規模でも、<br/>最初の制作費はいただきません。</p><h2>制作料<span>0</span>円<small>（税込）</small></h2></div><div className="price-table"><div><small>制作規模</small><strong>10〜20ページ</strong><p>事業に必要な情報量に合わせて設計</p></div><div><small>公開後</small><strong>月額 2,000円（税込）</strong><p>ご契約期間中は固定</p></div><div><small>募集</small><strong>先着3名</strong><p>申込状況に応じて手動で更新</p></div></div><p className="cost-note">※ サーバー代・ドメイン代は別途必要です。</p></section>
  ...
  <section className="new-cta" id="contact"><div className="cta-leaf">L</div><p>先着3名限定・制作料0円（税込）</p><h2>あなたの仕事を、<br/>きちんと伝える場所を。</h2><a href="#contact-note">無料で制作を相談する <span>↗</span></a><small id="contact-note">相談したからといって、契約する必要はありません。サーバー代・ドメイン代は別途必要です。</small></section>
